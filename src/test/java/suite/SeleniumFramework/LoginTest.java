...
public class LoginTest {
	...
	public void beforeClass(String browser, String url) throws IOException {
		...
		Reusable.waitUptoVisibilityOfElement(loginPage.prop.getProperty("btnLogin"), 60);
	}
	...
	public void TC_Login_02() throws Exception{
		...
		try{
			...
			Reusable.delay(3);
			String actualErrUserName=Reusable.getText(loginPage.prop.getProperty("errorUserName"));
			String actualErrPassword=Reusable.getText(loginPage.prop.getProperty("errorPassword"));
